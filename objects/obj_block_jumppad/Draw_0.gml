...
//Top wall
d3d_draw_wall(x,y+32,z,x+xlength,y+32,z+zlength,global.tex_misc_padtop,image_xscale,1);
//facing wall
d3d_draw_floor(x,y+32,z,x+xlength,y+32+ylength,z,global.tex_misc_padfront,image_xscale,1);
//Bottom wall
