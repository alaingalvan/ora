...
Top Menu
*/
draw_background_stretched(bac_oe_topbar, 0, 0, __view_get(e__VW.WView, 0), 43);
draw_set_font(fon_main18);
draw_text(12, 16, string_hash_to_newline("ORA Editor"));
draw_set_halign(fa_right);
draw_set_font(fon_main12);
draw_text(
  __view_get(e__VW.WView, 0) - 16,
  16,
  string_hash_to_newline(
    string(instance_count) + " obj | " + string(fps) + " fps | Version 0.5"
  )
);
