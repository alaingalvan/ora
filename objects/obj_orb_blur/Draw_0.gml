...
////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    d3d_draw_floor(x - (32*image_scale), y - (32*image_scale), z, x + (32*image_scale), y + (32*image_scale), z, global.tex_ora_smallglow, 1, 1);
    draw_set_color(c_white)
    d3d_draw_floor(x - (32*image_scale), y - (32*image_scale), z, x + (32*image_scale), y + (32*image_scale), z, global.tex_ora_mediumglow, 1, 1);
