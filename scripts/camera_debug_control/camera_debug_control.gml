function camera_debug_control() {
  ...
  var xsv, ysv;
  xsv =
    cos((global.camera_index[0].cam_angle_x + phy_surface_angle - 90) * pi180) *
    (phy_surface_spd / global.delta_fps);
  ysv =
    -sin(
      (global.camera_index[0].cam_angle_x + phy_surface_angle - 90) * pi180
    ) *
    (phy_surface_spd / global.delta_fps);
