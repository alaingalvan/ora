function config_load() {
  ...
  if (gamepad_is_supported()) {
    global.gamepad_deadzone[0] = ini_read_real("Gamepad 0", "Deadzone", 0.1);
    global.gamepad_jump[0] = ini_read_real(
      "Gamepad 0",
      "Jump Button",
      gp_face1
    );
  ...
  //Graphics
  global.res_x = ini_read_real(
    "Graphics",
    "Resolution Width",
    display_get_width()
  );
  global.res_y = ini_read_real(
    "Graphics",
    "Resolution Height",
    display_get_height()
  );
  global.aspect_ratio = ini_read_real(
    "Graphics",
    "Aspect Ratio",
    global.res_y / global.res_x
  );
