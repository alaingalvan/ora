...
if ds_grid_width(cur_list) > 0 + (cur_line * line_width)
{
    ...
    draw_text(32 + (96 / 2), 64 + 32 + 96 + 24, ds_grid_get(cur_list, 0 + (cur_line * line_width), 2))
}
if ds_grid_width(cur_list) > 1 + (cur_line * line_width)
{
    ...
    draw_text(32 + 48 + 96 + (96 / 2), 64 + 32 + 96 + 24, ds_grid_get(cur_list, 1 + (cur_line * line_width), 2))
}
if ds_grid_width(cur_list) > 2 + (cur_line * line_width)
{
    ...
    draw_text(32 + (48 * 2) + (96 * 2) + (96 / 2), 64 + 32 + 96 + 24, ds_grid_get(cur_list, 2 + (cur_line * line_width), 2))
}
...
if ds_grid_width(cur_list) > 3 + (cur_line * line_width)
{
    ...
    draw_text(32 + (96 / 2), 64 + 32 + (96 * 2) + 48 + 24, ds_grid_get(cur_list, 3 + (cur_line * line_width), 2))
}
if ds_grid_width(cur_list) > 4 + (cur_line * line_width)
{
    ...
    draw_text(32 + 48 + 96 + (96 / 2), 64 + 32 + (96 * 2) + 48 + 24, ds_grid_get(cur_list, 4 + (cur_line * line_width), 2))
}
if ds_grid_width(cur_list) > 5 + (cur_line * line_width)
{
    ...
    draw_text(32 + (48 * 2) + (96 * 2) + (96 / 2), 64 + 32 + (96 * 2) + 48 + 24, ds_grid_get(cur_list, 5 + (cur_line * line_width), 2))
}
...
if ds_grid_width(cur_list) > 6 + (cur_line * line_width)
{
    ...
    draw_text(32 + (96 / 2), 64 + 32 + (96 * 3) + (48 * 2) + 24, ds_grid_get(cur_list, 6 + (cur_line * line_width), 2))
}
if ds_grid_width(cur_list) > 7 + (cur_line * line_width)
{
    ...
    draw_text(32 + 48 + 96 + (96 / 2), 64 + 32 + (96 * 3) + (48 * 2) + 24, ds_grid_get(cur_list, 7 + (cur_line * line_width), 2))
...
if ds_grid_width(cur_list) > 8 + (cur_line * line_width)
{
    ...
    draw_text(32 + (48 * 2) + (96 * 2) + (96 / 2), 64 + 32 + (96 * 3) + (48 * 2) + 24, ds_grid_get(cur_list, 8 + (cur_line * line_width), 2))
}
