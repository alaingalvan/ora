...
function joystick_process_events() {
  if (argument_count > 0 && argument[0] > 0) return;

  // check to see if joystick 1 exists && process its events
  if (joystick_exists(1)) {
    ...
    if (joystick_check_button(1, 0))
      event_perform(ev_mouse, ev_joystick1_button1);
    if (joystick_check_button(1, 1))
      event_perform(ev_mouse, ev_joystick1_button2);
    if (joystick_check_button(1, 2))
      event_perform(ev_mouse, ev_joystick1_button3);
    if (joystick_check_button(1, 3))
      event_perform(ev_mouse, ev_joystick1_button4);
    if (joystick_check_button(1, 4))
      event_perform(ev_mouse, ev_joystick1_button5);
    if (joystick_check_button(1, 5))
      event_perform(ev_mouse, ev_joystick1_button6);
    if (joystick_check_button(1, 6))
      event_perform(ev_mouse, ev_joystick1_button7);
    if (joystick_check_button(1, 7))
      event_perform(ev_mouse, ev_joystick1_button8);
  }
